...
To briefly summarize the idea of `ggplot2` a plot is thought of as having several parts which are either background elements or individual layer elements.  
