...
Getting data into R can be somewhat frustrating for new users.  This is mainly because we humans (the author especially) tend to be somewhat sloppy when collecting data in a spreadsheet.  R has rigid expectations.  It expects each column of a text file (usually exported from an Excel sheet)
